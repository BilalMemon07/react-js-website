    ...
    render() {
        return (
            ...
            <Fade top cascade>
                ...
                <div className="newHabbits" style={{ textDecoration: 'none', transition: "all 0.5 ease"}}>Get started New Habbit <FontAwesomeIcon icon={faPlus} /> </div>
                <div style={{cursor:"pointer"}} className="justcont">
